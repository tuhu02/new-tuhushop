    ...
    const handleImportSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            reader.onload = (e) => {
                ...
                router.post(
                    `/admin/products/${product.id}/prices/import`,
                    {
                        items,
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            <Link
                                ...
                                className={`inline-flex h-9 items-center rounded-md border border-input bg-background px-4 text-sm font-medium ${prices.prev_page_url ? 'hover:bg-accent hover:text-accent-foreground' : 'pointer-events-none cursor-not-allowed opacity-50'}`}
                            >
                                Previous
                            </Link>
                            <Link
                                href={prices.next_page_url || '#'}
                                className={`inline-flex h-9 items-center rounded-md border border-input bg-background px-4 text-sm font-medium ${prices.next_page_url ? 'hover:bg-accent hover:text-accent-foreground' : 'pointer-events-none cursor-not-allowed opacity-50'}`}
                            >
                                Next
                            </Link>
                        </div>
                        ...
                        <form onSubmit={handleImportSubmit}>
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    />
                                    <p className="mt-1 text-xs text-muted-foreground">
                                        Kolom B: Kode, Kolom C: Nama, Kolom F:
                                        Harga
                                    </p>
                                </div>
                            </div>
