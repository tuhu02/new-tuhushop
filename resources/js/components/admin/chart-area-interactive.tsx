      ...
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Total {timeRange === '90d' ? '3 bulan' : timeRange === '30d' ? '30 hari' : '7 hari'} terakhir: {formatCurrency(totalRevenue)}
          </span>
          <span className="@[540px]/card:hidden">
            {timeRange === '90d' ? '3 bln' : timeRange === '30d' ? '30 hr' : '7 hr'}: {formatShortCurrency(totalRevenue)}
          </span>
        </CardDescription>
        <CardAction>
          <ToggleGroup
                    ...
                    return (
                        <div className="flex flex-col gap-1 w-full">
                            ...
                            <div className="flex justify-between items-center w-full gap-4">
                                ...
                                <span className="font-medium text-foreground">{item.payload.transactions}</span>
                            </div>
                        </div>
                    );
                  }}
