        ...
        carousels.length === 1
            ...
            : carousels.length === 2
              ...
              : [
                ...
                return (
                    <section className="relative px-4 py-8 md:px-8 lg:px-14">
                        <div className="relative mx-auto max-w-[1345px]">
                                        ...
                                        {thumbnails.map((item, i) => {
                                            ...
                                            if (!item) {
                                                return (
                                                    <div
                                                        key={`ghost-${i}`}
                                                        className="flex items-center gap-4 rounded-lg bg-slate-100 px-3 py-3"
                                                    >
                                                        <div className="h-[60px] w-[60px] shrink-0 rounded-lg bg-slate-200" />
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        isActive
                                                            ? 'border-[#ff3d5f] bg-white shadow-sm'
                                                ...
                                                >
                                                    <div className="h-[60px] w-[60px] shrink-0 overflow-hidden rounded-lg">
                                                        <img
                                                            src={item.image_url}
                                                            alt={item.title ?? 'carousel thumbnail'}
