    ...
    return (
        <AppShell variant="header">
            ...
            <AppContent variant="header">
                ...
                <div className="pointer-events-none absolute -top-28 left-1/2 h-130 w-[90vw] max-w-295 -translate-x-1/2 rotate-[-18deg] rounded-[90px] bg-indigo-100/45 dark:bg-indigo-500/12" />

                <div className="pointer-events-none absolute -top-16 left-[8%] hidden h-115 w-75 rotate-[-24deg] rounded-[60px] bg-indigo-200/25 md:block dark:bg-indigo-400/10" />

                <div className="pointer-events-none absolute -top-16 right-[8%] hidden h-115 w-75 rotate-24 rounded-[60px] bg-indigo-200/25 md:block dark:bg-indigo-400/10" />
